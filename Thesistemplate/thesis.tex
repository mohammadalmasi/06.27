...
\ftgrad{Master's Thesis}
\ftstudyprogram{Computer Science}
% title
...
\ftmatrno{112290}
\ftfaculty{Faculty of Computer Science and Mathematics}
\ftchair{Chair of Computer Engineering}
\ftchairholder{Prof. Dr. Stefan Katzenbeisser}
% 1. examiner
\ftgutachter{Prof. Dr. Stefan Katzenbeisser}
% 2. examiner
% Delete this line if you write a Bachelor thesis
\ftzweitgutachter{Prof. Dr. Joachim Posegga}
% supervisor
\ftbetreuer{Ms. Talaya Farasat and Ms. Aleena George}
% date of submission
\ftdate{2026-03-21}
