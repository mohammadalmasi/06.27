...
Several other works focus specifically on machine learning for Python vulnerability detection. Wartschinski et al.~\cite{VulnDetection} introduce VUDENC, a machine learning approach for vulnerability detection in Python code. VUDENC focuses on source code analysis, often using feature extraction and traditional or deep learning models on a natural codebase. Wang et al.~\cite{Wang2024DLPythonVuln} conduct an extensive study of the effects of different deep learning models on code vulnerability detection in Python, comparing multiple neural architectures. Bagheri and Hegedűs~\cite{Bagheri2021PythonVuln} compare different source code representation methods for vulnerability prediction in Python; their work uses BERT embeddings and LSTM networks, combining contextual code representations with sequence modeling for improved detection.
