...
This section presents a comprehensive comparison between Semgrep, a widely-used static analysis tool, and the custom web-based scanner developed in this thesis. The comparison covers their core approaches, capabilities, integration methods, and explains how the machine learning component is integrated into the custom scanner.
