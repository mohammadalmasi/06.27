...
const Header: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white/80 backdrop-blur border-b border-slate-200/70 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <button
            ...
            className="md:hidden p-2 rounded-md text-slate-700 hover:text-primary-700 hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-primary-400"
          >
            {isMenuOpen ? (
              <X className="h-6 w-6" />
            ) : (
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white/90 border-t border-slate-200/70 backdrop-blur">
              {navigation.map((item) => (
                <Link
                  key={item.name}
                  to={item.href}
