...
def main() -> None:
    ...
    # Static scanner
    print("\nRunning static CSRF detector...")
    static_scanner = StaticCSRFScanner()
    ...
    _summarize("Static CSRF detector", funcs, "static_hit")

    out_dir = Path(__file__).resolve().parent
    csv_path = out_dir / "comparison_ml_vs_static_csrf.csv"
...
# python -m scanners.csrf.compare_ml_vs_static_csrf
# python -m scanners.csrf.compare_semgrep_vs_ml_csrf
# python -m scanners.csrf.compare_semgrep_vs_static_csrf