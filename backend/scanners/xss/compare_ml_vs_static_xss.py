...
def main() -> None:
    ...
    csv_path = out_dir / "comparison_ml_vs_static_xss.csv"
...
# python -m scanners.xss.compare_ml_vs_static_xss
# python -m scanners.xss.compare_semgrep_vs_ml_xss
# python -m scanners.xss.compare_semgrep_vs_static_xss