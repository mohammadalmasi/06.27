...
#   2. Split the code into small words (tokens), e.g. "def", "user_name", "=", "request", ".", "args", ".", "get", "(", "\"name\"", ")", "return", "f\"", "<h1>Welcome", "{user_name}", "!", "</h1>\"",
...
#   5. If the number is >= 0.5 we say "potential XSS" and report the
#      line.
# =============================================================================
