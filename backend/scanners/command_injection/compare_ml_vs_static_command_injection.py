...
from scanners.command_injection.ml_command_injection_scanner import (
    MLCommandInjectionDetector,
)
from scanners.command_injection.static_command_injection_scanner import (
    StaticCommandInjectionScanner,
)


DATASET_PATH = Path(__file__).resolve().parent / "command_dataset.py"
...
def main() -> None:
    ...
    # ML scanner
    print("\nRunning ML Command Injection detector...")
    detector = MLCommandInjectionDetector(verbose=False)
    ...
    # Static scanner
    print("\nRunning static Command Injection detector...")
    static_scanner = StaticCommandInjectionScanner()
    ...
    # Summaries
    _summarize("ML Command Injection detector", funcs, "ml_hit")
    _summarize("Static Command Injection detector", funcs, "static_hit")

    out_dir = Path(__file__).resolve().parent
    csv_path = out_dir / "comparison_ml_vs_static_command_injection.csv"
...
# python -m scanners.command_injection.compare_ml_vs_static_command_injection
# python -m scanners.command_injection.compare_semgrep_vs_ml_command_injection
# python -m scanners.command_injection.compare_semgrep_vs_static_command_injection
