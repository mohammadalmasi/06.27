...
def _run_ml_scanner(path: Path, detector: MLCommandInjectionDetector) -> list:
    source = path.read_text(encoding="utf-8")
...
def main() -> None:
    ...
    # Run ML Command Injection detector
    ...
    csv_path = out_dir / "comparison_semgrep_vs_ml_command_injection.csv"
