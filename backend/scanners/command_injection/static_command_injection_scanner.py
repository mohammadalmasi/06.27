...
class StaticCommandInjectionScanner:
    """Command injection detector: taint + sink analysis. All scan and helper methods live here."""
    def __init__(self):
        pass
    ...
    def _make_taint_analyzer(self, filename, source_code):
        ...
        return TaintAnalyzer(
            ...
            sink_attrs={"system", "popen", "Popen", "spawn", "popen2", "popen3", "popen4", "call", "check_call", "check_output", "run"},
            sink_names={"system", "popen", "Popen", "spawn", "popen2", "popen3", "popen4", "call", "check_call", "check_output", "run", "eval", "exec"},
    ...
    def scan_url(self, url, timeout=30):
        ...
        req = Request(fetch_url, headers={"User-Agent": "Static-Command-Injection-Scanner/1.0"})
