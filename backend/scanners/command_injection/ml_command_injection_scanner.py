...
#   2. Split the code into small words (tokens), e.g. "def", "os", ".", "system", "(", "ls", ")", "print", "f\"", "The current directory is: ", "{os.getcwd()}", "!\"",
...
#   5. If the number is >= 0.5 we say "potential command injection" and report the
#      line.
# =============================================================================
