...
# venv/bin/python run_ml_csrf_scanner.py 0 "$(cat test_csrf_vulnerabilities.py)"
#
# Run: mode 1 → scan a file
# venv/bin/python run_ml_csrf_scanner.py 1 test_csrf_vulnerabilities.py
#
# Run: mode 2 → scan from URL (GitHub blob or raw)
# venv/bin/python run_ml_csrf_scanner.py 2 "https://github.com/owner/repo/blob/branch/path/file.py"
